...
public class Tab2_300x50  extends Activity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tab2_300x50);
        ...
        loadBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                banner = (Banner) findViewById(R.id.banner300);
                loadBanner();
            }
        });
