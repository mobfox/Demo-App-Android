...
public class URLVastInterstitial extends Activity {
...
//        getWindow().getDecorView().setBackgroundColor(Color.rgb(144,202,249));
        ...
        final URLVastInterstitial self = this;
        ...
        load.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    String vast_query = URLEncoder.encode(vast_url, "utf-8");
                    if(vast_query.length() > 0){
                        MobfoxRequestParams rqp = new MobfoxRequestParams();
                        rqp.setParam(MobfoxRequestParams.VAST_URL,vast_query);
                        interAd.setRequestParams(rqp);
                    }
                } catch (UnsupportedEncodingException e) {
                    e.printStackTrace();
                }
                interAd.loadVastCreative();
            }
        });
