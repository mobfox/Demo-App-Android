...
public class MobfoxNative extends Activity implements AdapterView.OnItemSelectedListener, View.OnClickListener {
...
//        Native.setDebug(true);
        ...
        listener = new NativeListener() {
            @Override
            public void onNativeReady(Native aNative, CustomEventNative event, com.mobfox.sdk.nativeads.NativeAd ad) {
                ...
                ad.loadImages(self, new com.mobfox.sdk.nativeads.NativeAd.ImagesLoadedListener() {
                    @Override
            ...
            @Override
            public void onNativeClick(com.mobfox.sdk.nativeads.NativeAd ad) {
